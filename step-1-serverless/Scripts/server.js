(function($) {
    ...
    // IE11 (and maybe other browsers) don't support localStorage on files
    if (localStorage === undefined || true) {
        window.partsList = null;
        window.vendorsList = null;
    }
    ...
    var parts = {
        get: function() {
            if (localStorage !== undefined){
                ...
                return JSON.parse(window.partsList);
            }
        },
        set: function(newParts) {
            if (localStorage !== undefined){
                ...
                window.partsList = JSON.stringify(newParts);
            }
        }
    };
    var vendors = {
        get: function() {
            if (localStorage !== undefined) {
                ...
                return JSON.parse(window.vendorsList);
            }
        },
        set: function(newVendors) {
            if (localStorage !== undefined) {
                ...
                window.vendorsList = JSON.stringify(newVendors);
            }
        }
    };
